    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="px-6 py-6">
        ...
        <div className="fixed bottom-6 right-6 flex flex-col space-y-3">
          <Link href="/legal" className="bg-gray-700 hover:bg-gray-600 text-white p-3 rounded-full shadow-lg transition-colors group">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/work" className="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full shadow-lg transition-colors group">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/" className="bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg transition-colors group">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
